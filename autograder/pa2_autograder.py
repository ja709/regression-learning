...
weight = {"testA.txt":10.0, "testB.txt":20.0, "testC.txt":10.0, "testD.txt":10.0, "testE.txt":10.0, "testF.txt":10.0, "testG.txt":10.0, "testH.txt":10.0, "testI.txt":10.0}
...
#    print "Grading", dirname
    ...
    if not os.path.isfile("learn"):
        print "Executable %s missing. Please check the compilation output."%("learn")
	os.chdir(prevdir)
	print "Score is ", score
	print ""
	print ""
    ...
    for test in list_tests:        
        ...
        ret = "";
        try:
            command_string = "./learn " + train_file + " " + test_dir + test
...
#            	print "Deleting the directory obj_temp."
	...
	print "dir is ", prevdir
        ...
        os.chdir(prevdir)
    print "Your TOTAL SCORE = ", str(total_score) + "/100";
